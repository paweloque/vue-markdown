...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _markdownItKatexx = __webpack_require__(13);

	var _markdownItKatexx2 = _interopRequireDefault(_markdownItKatexx);
	...
	exports.default = {
	  ...
	  render: function render(createElement) {
	    ...
	    this.md = new _markdownIt2.default().use(_markdownItSub2.default).use(_markdownItSup2.default).use(_markdownItFootnote2.default).use(_markdownItDeflist2.default).use(_markdownItAbbr2.default).use(_markdownItIns2.default).use(_markdownItMark2.default).use(_markdownItKatexx2.default, { "throwOnError": false, "errorColor": " #cc0000" }).use(_markdownItTaskLists2.default, { enabled: this.taskLists });
